//! Integration tests for `schemas/plan/plan.schema.json`.
//!
//! These are pure-library tests: they compile the bundled JSON Schema and
//! feed it YAML fixtures converted to `serde_json::Value`. No CLI invocation,
//! no temp directories, no workspace scaffolding.
