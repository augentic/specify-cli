...
",
    ...
    #[test]
    fn plan_archive_refuses_without_force_on_pending_entries() {
        let project = Project::init();
        project.seed_plan(A_DONE_B_PENDING);
    ...
    #[test]
    fn plan_archive_with_force_on_pending_succeeds() {
        let project = Project::init();
        project.seed_plan(A_DONE_B_PENDING);
    ...
    #[test]
    fn plan_archive_filename_is_kebab_plan_name_plus_yyyymmdd() {
        let project = Project::init();
        project.seed_plan(
            "\
name: my-initiative
...
",
    ...
    #[test]
    fn plan_archive_refuses_when_destination_exists() {
        let project = Project::init();
        project.seed_plan(ALL_DONE);
    ...
    #[test]
    fn plan_archive_missing_plan_file_errors() {
        let project = Project::init();
        // Deliberately do NOT seed plan.yaml.
