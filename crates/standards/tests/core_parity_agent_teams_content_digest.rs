...
//! The C16 plan card named `crates/standards/src/framework/check/agent_teams.rs`
...
//! (`crates/standards/src/lint/index/agent_teams.rs::record`)
...
//! [`specify_standards::lint::AgentTeam`] fact per followed
...
//! (`crates/standards/src/lint/eval/content_digest_eq.rs::evaluate`)
