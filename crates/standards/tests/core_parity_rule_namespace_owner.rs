...
//! `crates/standards/src/framework/check/rules.rs` `BUILTIN_NAMESPACES`
...
//! [`specify_standards::lint::Frontmatter`] fact per rule markdown file
//! (`crates/standards/src/lint/index/frontmatter.rs::extract`); the
//! `kind: namespace-owner` interpreter
//! (`crates/standards/src/lint/eval/namespace_owner.rs::evaluate`)
