...
//!   `crates/standards/src/framework/check/tools.rs::FirstPartyTools`, asserts
...
//!   one [`specify_standards::lint::AdapterManifest`] fact per well-formed
...
//!   (`crates/standards/src/lint/eval/constant_eq.rs::evaluate`)
