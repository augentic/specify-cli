...
pub(super) const RULE_ENVELOPE_JSON_IN_BODY: &str = "skill.envelope-json-in-body";
pub(super) const RULE_STEP_BODY_DUPLICATES: &str = "skill.step-body-duplicates-critical-path";
pub(super) const RULE_FRONTMATTER_RESTATEMENT: &str = "skill.frontmatter-restatement";
...
impl_skill_body_check!(
    ...
    envelope::check_no_envelope_examples
);
impl_skill_body_check!(
...
impl_skill_body_check!(
    ...
    section::check_no_frontmatter_restatement
);
