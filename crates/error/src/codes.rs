...
pub const WIRE_CODES: &[&str] = &[
    ...
    "filesystem-migrate-commit",
    "filesystem-migrate-read-source",
    "filesystem-migrate-stage",
    "filesystem-mkdir",
    ...
    "migrate-consent-required",
    "migrate-from-unknown",
    "migrate-version-unparseable",
    "not-initialized",
    "parts-schema",
    ...
    "workspace-gh-pr-create-failed",
    "workspace-gh-pr-create-no-number",
    "workspace-gh-pr-edit-failed",
    "workspace-gh-pr-list-failed",
    "workspace-gh-pr-list-malformed",
    "workspace-gh-repo-create-failed",
    "workspace-gh-repo-view-failed",
    "workspace-gh-spawn-failed",
    ...
    "workspace-origin-head-unresolved",
    "workspace-origin-mismatch",
    "workspace-origin-missing",
    "workspace-pr-base-equals-branch",
