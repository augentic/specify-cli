...
the call site(s) that implement it. Inline comments in `src/engine/`
...
_Codified in: `crates/vectis-validate/src/engine/layout.rs::validate_layout`,
...
_Codified in:
`crates/vectis-validate/src/engine/assets.rs::validate_assets`,
...
_Codified in:
`crates/vectis-validate/src/engine/composition.rs::resolve_token_references`,
...
_Codified in:
`crates/vectis-validate/src/engine/composition.rs::check_structural_identity`,
...
_Codified in:
`crates/vectis-validate/src/engine/paths.rs::{resolve_default_path,
...
_Codified in:
`crates/vectis-validate/src/engine/composition.rs::validate_composition`
...
_Codified in:
`crates/vectis-validate/src/engine/shared.rs::TOKENS_SCHEMA_SOURCE`
...
_Codified in:
`crates/vectis-validate/src/engine/shared.rs::ASSETS_SCHEMA_SOURCE`,
...
_Codified in: `crates/vectis-validate/tests/engine_layout.rs::APPENDIX_C_LAYOUT_YAML`._
...
_Codified in: `crates/vectis-validate/tests/engine_tokens.rs::APPENDIX_D_TOKENS_YAML`._
...
_Codified in: `crates/vectis-validate/tests/engine_assets.rs::APPENDIX_E_ASSETS_YAML`._
...
_Codified in: `crates/vectis-validate/src/engine/composition.rs::check_structural_identity`
...
_Codified in: `crates/vectis-validate/src/lib.rs` (the public
...
_Codified in:
`crates/vectis-validate/src/engine/shared.rs::escape_pointer_token`
