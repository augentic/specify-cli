...
pub struct ProposeOutcome {
    ...
    /// order the kernel wrote `plan.yaml.slices[]`. When platform
    /// reconciliation inserts bootstrap slices, they are prepended
    /// before the agent's feature slices.
    pub slice_names: Vec<String>,
}

/// Platforms that a single project is missing on disk.
///
