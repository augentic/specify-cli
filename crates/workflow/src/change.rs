...
pub use plan::core::{
    ...
    ProjectMissingPlatforms, ProjectRef, ProposalKind, ProposalRequest, ProposalResponse, ProposeOutcome, ResponseMember,
    ResponseSlice, SliceAuthorityOverride, SliceSourceBinding, SourceBinding, Status, TargetRef,
    TargetRefParseError, build_catalog, build_request, detect_missing_platforms, emit_authority_override_seed_events,
