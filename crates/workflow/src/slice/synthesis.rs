//! Slice synthesis projection kernel (RFC-29c M2b).
//!
...
//! derivation, and per-claim winner markers (RFC-29c §"Authority
//! resolution", §"Status derivation"). The kernel consumes data the
