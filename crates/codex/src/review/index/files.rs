...
//! umbrella in [`crate::review::index`] hands to the per-file
//! extractors.
...
use crate::review::{FileKind, Symlink};
...
mod tests {
    ...
    fn include_filter_accepts_dot_specify_paths() {
        ...
        assert!(is_included(".specify/cache/codex/adapters/shared/codex/universal/UNI-099.md"));
    }
