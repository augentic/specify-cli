...
| [`manifest-meta.schema.json`](manifest-meta.schema.json) | Validates the manifest mirror's provenance stamp at `.specify/cache/manifests/manifest-meta.yaml` (the structural twin of `codex/codex-meta.yaml`). |
